...
const themeConfig: DefaultTheme.Config = {
  ...
  socialLinks: [
    {
      icon: 'github',
      link: 'https://github.com/rokku-app/rokku',
  ...
  footer: {
    ...
    copyright: `Copyright © ${new Date().getFullYear()} Rokku`,
  },

  editLink: {
    pattern: 'https://github.com/rokku-app/rokku-app.github.io/edit/master/website/src/:path',
