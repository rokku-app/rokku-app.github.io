...
## Where can I find repositories/extensions for Rokku?
Rokku does not have, associate, or provide any repositories or extensions.
...
Rokku is bring-your-own-content and does not offer anything.

::: info Disclaimer
**Rokku** isn't responsible for slow, down, missing chapters, or subpar image quality of sources as it doesn't host the content.
:::
...
Uninstall extensions like regular apps: through device settings or in **Rokku**.

::: tip Uninstalling an extension
In **Rokku**, uninstall an extension via <nav to="extensions">, then tap **Uninstall** on the chosen extension.
:::
