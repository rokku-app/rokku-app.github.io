...
1. **Restart Rokku**: Force close and reopen the app.
...
If none of these solutions help, try asking by [opening an issue](https://github.com/rokku-app/rokku/issues).
...
## Personalized issue
If you're the only one facing a problem, you might be encountering [Cloudflare](/docs/guides/troubleshooting/#cloudflare) protection, an IP ban, or other countermeasures set by website owners against programs like **Rokku**.
...
1. Check [open issues](https://github.com/rokku-app/rokku/issues).
2. Check [closed issues](https://github.com/rokku-app/rokku/issues?q=is%3Aissue+is%3Aclosed) in case it's resolved but not yet released.
