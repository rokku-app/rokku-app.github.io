...
description: Using Shizuku with Rokku.
---

# Shizuku
**Shizuku** is an alternative method for installing and updating extensions in **Rokku**.
...
After configuring it, enable **Shizuku** within **Rokku** by navigating to <nav to="advanced"> then changing the **Installer** setting.
