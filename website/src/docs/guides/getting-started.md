...
description: Essential information to help you get set up with Rokku.
---
...
Essential information to help you get set up with Rokku.

## Installation guide

### Downloading Rokku

1. Visit our [download](/download/) page to get the latest version of **Rokku**.
2. After the download is complete, open the `.apk` file.
3. Proceed with the installation process.

### Adding sources

Once **Rokku** is installed on your device, you can bring your own content to read from various sources:
...
External repositories add additional sources to **Rokku**:
...
::: danger Caution
Rokku will not provide resources for any unofficial repositories. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
...
::: danger Caution
Rokku will not provide resources for any unofficial extensions. Beware that any third-party repositories or extensions will have full access to the app and may contain malware.
:::
::::
