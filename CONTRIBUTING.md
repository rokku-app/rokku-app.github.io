# Rokku Website Contributing Guide
...
- Use `.webm` format
  - Encode it with our [HandBrake profile](./.github/assets/mihon-handbrake-profile.json) (inherited from Mihon; still applicable)
...
[![List of Contributors](https://contrib.rocks/image?repo=rokku-app/rokku-app.github.io 'List of Contributors')](https://github.com/rokku-app/rokku-app.github.io/graphs/contributors)
